		...
		<h3 class="yay-swatches-product-attribute-header">
			...
			<div class="yay-swatches-product-attribute-type-wrapper">
				<select class="yay-swatches-attribute-type-select">
					<option value="default" <?php selected( $yay_swatches_attribute['type'], 'default' ); ?>><?php echo esc_html__( 'Default (Button)', 'yay-swatches' ); ?></option>
				...
				<select style="width: 230px !important;" class="yay-swatches-attribute-type-select">
					<option value="default" <?php selected( $yay_swatches_attribute['type'], 'default' ); ?>><?php echo esc_html__( 'Default (Display on Shop page)', 'yay-swatches' ); ?></option>
					<option value="custom" <?php selected( $yay_swatches_attribute['type'], 'custom' ); ?>><?php echo esc_html__( 'Don\'t display on Shop page', 'yay-swatches' ); ?></option>
				</select>
			</div>
		</h3>
